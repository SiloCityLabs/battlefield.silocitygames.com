...
export default function Changelog() {
  ...
  return (
    <>
      <Head>
        <title>Changelog - Battlefield Random Class Generator</title>
        <link rel="manifest" href="/manifest.json" />
        <meta
          name="description"
          content="Stay up-to-date on the latest features, bug fixes, and improvements to our Battlefield random class generators. See what's new and how we're making your loadout experience even better."
        />
