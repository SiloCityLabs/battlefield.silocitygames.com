...
export default function BattlefieldHardlineInfo() {
  const navLinks = [
    { label: "Home", href: "/" },
  ...
  return (
    <>
      <Head>
        <title>Battlefield Hardline Loadout Information</title>
        <link rel="manifest" href="/manifest.json" />
        <meta
          name="description"
          content="Loadout Information for Battlefield Hardline. Checkout all the weapons, gadgets, grenades, and melee combinations."
        />
        <meta
          name="keywords"
